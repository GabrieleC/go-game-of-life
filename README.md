Conway's [Game Of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life) implementation using [Go programming language](https://en.wikipedia.org/wiki/Go_(programming_language)):
